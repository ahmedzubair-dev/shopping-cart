...
<body style="background-color: #ECCEAE;">
	<!--Company Header Starting  -->
	<div class="container-fluid text-center"
		style="margin-top: 80px; background-color: #E68369; color: white; padding: 5px; height: 180px;">
		...
		<form class="form-inline" action="index.jsp" method="get">
			<div class="input-group">
				<input type="text" class="form-control" size="50" name="search"
					placeholder="Search Items" required style="     border-radius: 15px 0 0 15px;">
				<div class="input-group-btn">
					<input type="submit" class="btn btn-danger"  style="     border-radius: 0 15px 15px 0;" value="Search" />
				</div>
			</div>
		</form>
		<p align="center"
